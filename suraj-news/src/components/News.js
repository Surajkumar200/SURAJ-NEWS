...
export class News extends Component {
  ...
  constructor(props) {
    ...
    document.title = `${this.capitalizeFirstLetter(this.props.category)}  - Suraj-News apko rakhe age`;
  }
  ...
  render() {
    return (
      <>
        <h1 className="text-center" style={{ margin: '35px 0px', marginTop: '90px' }}>Suraj News - Letest {this.capitalizeFirstLetter(this.props.category)} Headlines</h1>
